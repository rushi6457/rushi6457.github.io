    ...
    return (
       ...
       className='about-section' id='about'>
            <div className='text-about'>
                ...
                <br />
                <p className="details-full">A passionate Full-stack web developer with strong technical as well as communication skills, the goal-oriented programmer who can write efficient and clean code using the MERN stack. In the past few months, I have worked on JavaScript, Typescript, Redux, and frameworks like Node JS. I have hands-on experience with front-end libraries like React-Js and backend technologies such as MongoDB, and express JS. Apart from that, I'm a B-tech graduate in Mechanical from D.Y.Patil Institute of Engineering, Pune</p>
                {/* </div> */}
            </div>
            <div>
